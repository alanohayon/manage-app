...
if (mysqli_num_rows($resulVerif) == 0) {
    ...
    $req = "Update tickets set statut = 'Termine' where idt='$idt'"; //requette qui met a jour le statut du probleme et qui enregistre le technicien ayant pis en charge le problemme 
