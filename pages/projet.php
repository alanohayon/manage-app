...
<body>
    <div id="body" x-data="{ isOpen: false, modifierStatut: false, isOpenMembre: false, ajouterMembre: false, ajouterTechnicienSurTache: false,  currentTaskId: null}">
            ...
            <ol role="list" class="flex items-center space-x-4 w-3/4 my-4 p-4 border border-4">
                ...
                <li>
                    <div class="flex items-center -ml-2">
                        ...
                        <a href="#" class="text-xl font-medium text-gray-700 hover:text-gray-700 hover:underline" aria-current="page">
                            <p>Projet: <?php echo "" . $projetDetails['nom_projet'] . "</p>"; ?>
                        </a>
                    </div>
                </li>
            </ol>
        ...
        <div class="bg-white p-8 w-full flex justify-center">
            <h2 class="text-4xl text-center font-bold border-emerald-500" style="     color: black;
                ...
                <div>
                    <div class="sm:flex w-full flex justify-center mb-2">
                        <div class="sm:flex-auto p-3">
                            <h1 class="text-lg leading-6 text-gray-900 border-orange-500 font-bold	" style="     color: black;
        ...
        <div class="flex w-full justify-center mt-6">
            ...
            <div id="tasks" class="rounded-lg w-5/6 flex justify-center" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
                <div class="mt-8 w-full px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="sm:flex sm:items-center w-full flex justify-center">
                        <div class="sm:flex-auto">
                            <h1 class="text-2xl font-semibold leading-6 text--900" style="     color: black;
                                    ...
                                    <table class="min-w-full divide-y divide-gray-300">
                                        <thead class="bg-gray-50">
                                            <tr>
                                                ...
                                                <th scope="col" class="px-3 py-3.5 text-center text-sm font-semibold text-gray-900">Date de création</th>
                                                <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">Tâche</th>
                                                <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">Editeur</th>
                                                <th scope="col" class="px-3 py-3.5 text-center text-sm font-semibold text-gray-900">Assigné à...</th>
                                                <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">Précision</th>
                                                <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6 ">Description</th>
                                                <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6 " >Fichier</th>
                                                <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">Complexité</th>
                                                <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">Pirorité</th>
                                        ...
                                        <tbody class="divide-y divide-gray-200 bg-white">
                                            ...
                                            <?php foreach ($taches as $tache) : ?>
                                                ...
                                                $prenEditeur = $userModel->getPrenomById($tache['id_tech']); ?>
                                                <tr>
                                                    <!-- AFFICHER DATE CREATION------------->
                                                    <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6"><?= $tache['date_creation'] ?></td>

                                                    <!-- AFFICHER LE TITRE------------->
                                                    <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6"><?= $tache['titre'] ?></td>

                                                    <!-- AFFICHER L'EDITEUR'------------->
                                                    <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6"><?= $prenEditeur ?></td>

                                                    <!------------------------------------------------------------------------------------------------>
                                                    <!-- AFFICHER LES TECHNICIENS -->
                                                    <!-- BOUTON AJOUTER UN TECH -->
                                                    <!-- FENETRE AJOUTER UN TECH -->
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500 flex flex-row items-center justify-center">
                                                        <!------------------------------------------------------------------------------------------------>
                                                        <!-- AFFICHER LES TECHNICIENS -->
                                                    ...
                                                    <!------------------------------------------------------------------------------------------------>
                                                    <!-- AFFICHER LA PRECISION 5eme colonnes -->
                                                    <td>
                                                        <div class="flex flex-col justify-center">
                                                            <p class="text-sm leading-6 text-gray-900"><?= $tache['precision'] ?></p>
                                                        </div>
                                                    </td>
                                                    <!-- AFFICHE DESCRIPTION -->
                                                    <td>
                                                        <div class="flex flex-col justify-center max-w-xs max-h-10 overflow-y-scroll ">
                                                            <p class="text-sm leading-6 "><?= $tache['description'] ?></p>
                                                        </div>
                                                    </td>
                                                    <!-- AFFICHE FICHIER-->
                                                    <td>
                                                        <div class="flex flex-col justify-center ">
                                                            <?php if ($tache['fichier'] == NULL) { //si il n'y a pas de fichier 
                                                    ...
                                                    <td>
                                                        <div class="flex flex-col justify-center">
                                                            <p class="text-sm leading-6 text-gray-900"><?= $tache['complexite'] ?></p>
                                                        </div>
                                                    </td>
                                                    <!-- AFFICHE PRIORITE -->
                                                    <td>
                                                        <div class="flex flex-col justify-center">
                                                            <p class="text-sm leading-6 text-gray-900"><?= $tache['priorite'] ?></p>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                        <div class="flex flex-col justify-center">
                                                            ...
                                                            <!------------------------------------------------------------------------------------------------>
                                                            <!-- FENETRE DE FORMULAIRE DE L'AJOUT D'UN TECHNICIEN A UNE TACHE  -->
                                                            <div x-show="modifierStatut" class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true" id="ajout-technicien-dans-projet">
                                                    ...
                                                    <!------------------------------------------------------------------------------------------------>
                                                    <!-- AFFICHER LA DATE FIN -->
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><?= $tache['date_de_fin'] ?></td>
        ...
        <div x-show="isOpen" class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true" id="ajout-tache-dans projet">
            ...
            <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <div class="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                        <form action="projet.php?id_projet=<?php echo $id_projet; ?>" method="post" enctype='multipart/form-data'>
                            <div>
                                <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-green-100">
                                    <svg class="h-6 w-6 text-green-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                                ...
                                <div class="mt-3 text-center sm:mt-5">
                                    ...
                                    <!-- Type de tache -->
                                    <!-- <div>
                                        <label for="typeTache" class="font-semibold text-gray-600 py-2">Type de tâche :</label>
                                        <select class="block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4 md:w-full " name="tache">
                                            file deroulante avec les differents types de taches 
                                            <option value="nvlFct">Créer une nouvelle fonctionnalité</option>
                                            <option value="DmdModif">Demande de modification</option>
                                            <option value="Bug">Bug à resoudre</option>
                                    ...
                                    <div>
                                        <label for="typeTache" class="block text-sm font-medium text-gray-700  text-left mt-2 mr-1.5">Précision :</label>
                                        <select class="block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4 md:w-full " name="precision">
                                            <option value="interface">Interface (FrontEnd)</option>
                                            <option value="code" selected>Modification de code (préciser la page)</option>
                                    ...
                                    <div>
                                        <label for="typeTache" class="block text-sm font-medium text-gray-700  text-left mt-2 mr-1.5">Complexité :</label>
                                        <select class="block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4 md:w-full " name="complexite">
                                    ...
                                    <!-- Ajout fichier -->
                                    <div>
                                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Ajouter un fichier</label>
                                        <input class="block w-full mb-5 text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 
                                        focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" name="fichier" type="file">
                                    </div>
                                    ...
                                    <div>
                                        <label for="typeTache" class="block text-sm font-medium text-gray-700  text-left mt-2 mr-1.5">Pirorité :</label>
                                        <select class="block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4 md:w-full " name="priorite">
                                            <option value="faible" selected>Faible</option>
                                            <option value="moderee">Modérée</option>
                                            <option value="Elevee">Elevée</option>
                                            <option value="Elevee">Urgent (Vraiment urgent)</option>
