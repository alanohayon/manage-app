                    ...
                    <form method="post">
                        ...
                        <div class="flex flex-row">
                            <div class="w-3/4 flex flex-col mb-32">
                                ...
                                <div class="w-full flex flex-row pl-4 space-between mt-3">
                                    <div class="w-10/12">
                                        <label for="affinite1" class="block text-sm font-medium leading-6 text-gray-900">Affinité 1</label>
                                        <div class="mt-2">
                                            <select name="affinite1" id="affinite1" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                                <option value="FrontEnd">FrontEnd</option>
                                                <option value="BackEnd">BackEnd</option>
                                                <option value="BDD">Base de données</option>
                                                <option value="Interface UI/UX">Interface UI/UX</option>
                                ...
                                <div class="w-full flex flex-row pl-4 space-between mt-3">
                                    <div class="w-10/12">
                                        <label for="affinite1" class="block text-sm font-medium leading-6 text-gray-900">Affinité 1</label>
                                        <div class="mt-2">
                                            <select name="affinite2" id="affinite2" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                                <option value="FrontEnd">FrontEnd</option>
                                                <option value="BackEnd">BackEnd</option>
                                                <option value="BDD">Base de données</option>
                                                <option value="Interface UI/UX">Interface UI/UX</option>
                                ...
                                <div class="w-full flex flex-row pl-4 space-between mt-6">
                                    <div class="w-10/12">
                                        <p class="text-xs">
                                            ...
                                            utilisées à des fins publicitaires (pour l'instant). <a href="#" class="text-blue-500">En savoir plus</a>
                                        </p>
                                    </div>
                                </div>
