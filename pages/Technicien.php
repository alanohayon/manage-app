...
<head>
  ...
  <link rel="stylesheet" href="style/style-techni_resp.css">
...
<td>";
echo "<a href='../fonctions/chatTech.php'><img src='../img/chat.png' width='20'>";  //possibilité de parler avec le client ou le responsable
  echo "</td>
<td>". $ligne["statut"]."</td>
<td>";
if ($statut =="En attente"){  //si le statut du probleme est 'en attente'
  echo" 
  <a href='commencer.php?idp=". $ligne["idp"]. "'><img src='../img/jouer.png' width='20'><a/>";
